...
import com.sygt.system.mapper.SysRoleMenuMapper;
import com.sygt.system.mapper.SysUserRoleMapper;
...
import com.sygt.system.domain.SysRoleMenu;
...
public class SysRoleServiceImpl implements ISysRoleService {
    ...
    public void init() {
        ...
        List<SysRole> userList = roleMapper.selectRoleList(new SysRole());
    ...
    public List<SysRole> selectRoleAll() {
        ...
        sysRole.setStatus(Constants.STSTUS_0);
    ...
    public int deleteRoleByIds(Long[] roleIds) {
        ...
        int i = roleMapper.deleteRoleByIds(roleIds);
        // 清空缓存
        this.clearRoleCache();
        // 重新加载缓存
        this.init();
    ...
    @Override
    public Long getUserIdById(Long roleId) {
        return roleMapper.getUserIdById(roleId);
    }
    ...
    public static void clearRoleCache() {
        Collection<String> keys = SpringUtils.getBean(RedisCache.class).keys(Constants.SYS_ROLE_KEY + "role_list");
