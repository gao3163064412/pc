package com.sygt.common.utils.poi;
...
import com.sygt.common.core.text.Convert;
...
import com.sygt.common.utils.file.FileTypeUtils;
import com.sygt.common.utils.file.ImageUtils;
import com.sygt.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
    ...
    public List<T> importExcel(String sheetName, InputStream is) throws Exception {
        ...
        if (sheet == null) {
//            throw new IOException("请上传正确的模板");
            throw new CustomException("请上传正确的模板", HttpStatus.NOT_IMPLEMENTED);
        }
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = LimsConfig.getDownloadPath() + filename;
